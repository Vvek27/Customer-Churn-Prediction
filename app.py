...
st.markdown(
   ...
   .sidebar .sidebar-content {
        background: url("ttps://images.pexels.com/photos/1037995/pexels-photo-1037995.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260")
    }
    </style>
    """,
...
def main():
    ...
    if choice=="EDA":
        ...
        credit_col=st.number_input("Enter customer credit score")
        ...
        Balance_col=st.number_input("Enter customer balance")
        ...
        salary=st.number_input("Enter the salary of customer")
        col_list[8]=salary
        ...
        st.text("Streamlit app made by Vivek")
